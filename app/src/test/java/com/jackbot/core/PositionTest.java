...
public class PositionTest {
  ...
  void testEnPassantPosition() {
    Position enPassant = Fen.parse(FEN_EN_PASSANT);
  ...
  void testInvalidAmountOfArgs() {
    ...
    assertThrows(IllegalArgumentException.class, () -> Fen.parse(invalidArgs));
  }

  @Test()
  void testInvalidFenPiecePosition() {
    String invalidAmountOfRanks = "8/8/8/8/8/8/8 w - - 0 0";
    assertThrows(IllegalArgumentException.class, () -> Fen.parse(invalidAmountOfRanks));
    String invalidAmountOfFiles = "9/8/8/8/8/8/8/8 w - - 0 0";
    assertThrows(IllegalArgumentException.class, () -> Fen.parse(invalidAmountOfFiles));
    String invalidPieceNotation = "8/f7/8/8/8/8/8/8 w - - 0 0";
    assertThrows(IllegalArgumentException.class, () -> Fen.parse(invalidPieceNotation));
  }

  @Test()
  void testInvalidSideToMovePosition() {
    String invalidSideToMove = "8/8/8/8/8/8/8/8 c - - 0 0";
    assertThrows(IllegalArgumentException.class, () -> Fen.parse(invalidSideToMove));
  }

  @Test()
  void testInvalidCastlingPosition() {
    String invalidCastlingPosition = "8/8/8/8/8/8/8/8 w b - 0 0";
    assertThrows(IllegalArgumentException.class, () -> Fen.parse(invalidCastlingPosition));
  }

  @Test()
  void testInvalidEnPPosition() {
    String invalidEnPPositionInvalidEntry = "8/8/8/8/8/8/8/8 w - e 0 0";
    assertThrows(IllegalArgumentException.class, () -> Fen.parse(invalidEnPPositionInvalidEntry));
    String invalidEnPPositionInvalidSquare = "8/8/8/8/8/8/8/8 w - q5 0 0";
    assertThrows(IllegalArgumentException.class, () -> Fen.parse(invalidEnPPositionInvalidSquare));
  }

  @Test()
  void testInvalidMoveCounterPosition() {
    String invalidHalfmovePosition = "8/8/8/8/8/8/8/8 w - - a 0";
    assertThrows(IllegalArgumentException.class, () -> Fen.parse(invalidHalfmovePosition));
    String invalidTotalMovePosition = "8/8/8/8/8/8/8/8 w - - 0 a";
    assertThrows(IllegalArgumentException.class, () -> Fen.parse(invalidTotalMovePosition));
  }
}
